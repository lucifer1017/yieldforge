...
/**
 * @title USDCVault
 * @dev ERC4626-compliant vault for USDC deposits with AI-powered yield optimization
 * @notice This vault handles USDC deposits, mints shares, and provides hooks for automation
 * @author YieldForge Team
 */
contract USDCVault is ERC4626, ReentrancyGuard, Pausable, AccessControl {
    ...
    /// @notice Maximum deposit amount (1M USDC with 6 decimals)
    ...
    /**
     * @notice Deposit USDC and mint vault shares
    ...
    /**
     * @notice Approve bridge contract to spend USDC for cross-chain operations
     * @dev Only callable by authorized agents or bridge contracts
     * @param bridge Address of the bridge contract
     * @param amount Amount of USDC to approve
     */
     ...
     * @return Total USDC balance of the vault
     */
